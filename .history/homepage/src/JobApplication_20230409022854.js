  ...
  return (
    <Container className="job-application-container">
      ...
      <Form onSubmit={handleSubmit} className="job-application-form" >
        <Row>
          <Col>
            <Card className="job-application-card mb-4">
              <Card.Header className="job-application-card-header">Email</Card.Header>
            ...
            <Card className="job-application-card mb-4">
              <Card.Header  className="job-application-card-header">Name</Card.Header>
              <Card.Body className="job-application-card-body">
                <Form.Group>
        ...
        <Card className="job-application-card mb-4">
          <Card.Header className="job-application-card-header">CV Upload</Card.Header>
          <Card.Body  className="job-application-card-body">
            <Form.Group>
        ...
        <Card className="job-application-card mb-4">
          <Card.Header className="job-application-card-header">Cover Note</Card.Header>
          <Card.Body className="job-application-card-body">
            <Form.Group>
