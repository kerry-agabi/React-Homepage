    ...
    <Container>
      <Card>
        ...
        <ul>
          ...
          <li>
            TotalWorkingYears: Total years the employee working in any
            organization
          </li>
          <li>
            TrainingTimesLastYear: Last year how many times employee took
            training session.
          </li>
          <li>WorkLifeBalance 1 'Bad' 2 'Good' 3 'Better' 4 'Best'</li>
          <li>
            YearsAtCompany: How many years the employee working in the current
            organization
          </li>
          <li>
            YearsInCurrentRole: How many years the employee working in the
            current position
          </li>
          <li>
            YearsSinceLastPromotion: How many years the employee working in the
            current position after promotion
          </li>
          <li>
            YearsWithCurrManager: How many years the employee working under the
            current manager
          </li>
          <li> </li>
          <li> </li>
