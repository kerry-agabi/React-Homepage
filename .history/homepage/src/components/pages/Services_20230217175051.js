...

{
  ...
  return (
    <div className={`flex bg-white shadow-md my-16 mx-10 p-6 rounded ${featured && 'border-l-8 border-black border-solid'}`}>
      <div>
      ...
      <div className="bg-flex item-center ml-auto">
        {tags
          ? tags.map((tag) => (
              <span onClick = {()=> handleTagClick(tag)}className="text-blue-100 bg-blue-400 font-bold m-3 p-2 rounded">
                {tag}
              </span>
            ))
          : ""}
