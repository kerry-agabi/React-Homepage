...
import { calculateMatchingScore } from './View';

function JobCardAlgo() {
  ...
  .sort((a, b) => {
    if (User1 && User1.jobSeeker) {
      const aMatchingScore = calculateMatchingScore(a, User1.jobSeeker).score;
      const bMatchingScore = calculateMatchingScore(b, User1.jobSeeker).score;
      if (bMatchingScore !== aMatchingScore) {
