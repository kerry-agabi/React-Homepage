...
function UpdateJob() {
  ...
  const handleSubmit = async (event) => {
    ...
    await updateDoc(jobDocRef, {
      ...
      date: job.date,
      Link: job.Link,
      ImageUrl: newImageUrl || job.ImageUrl, // Use the new image URL if provided, otherwise use the existing one
    ...
    <div className="UpdateJob">
      <Container>
        <Card className="UpdateJob-card">
          <Card.Header className="UpdateJob-card-header">Update Job Details</Card.Header>
            ...
            <Form onSubmit={handleSubmit}>
              {[
                ...
                <Form.Group
                  ...
                  key={field.name}
                >
                   <Form.Group controlId="current-image-url-for-my-form">
                <Form.Label>Current Company Logo</Form.Label>
                <img src={job.ImageUrl} alt="Current company logo" style={{ height: "100px", objectFit: "cover" }} />
              </Form.Group>
              <Form.Group controlId="new-image-url-for-my-form">
                <Form.Label>New Company Logo URL</Form.Label>
                <Form.Control
                  type="text"
                  name="NewImageUrl"
                  placeholder="New company logo URL"
                  value={newImageUrl}
