...
//start
  return (
    <div className="mt-6">
      <Container>
      <Card className={`w-100 mx-auto ${styles.updateDashboard}`}>
        ...
        <Card className={`mx-auto ${styles.profilePhoto}`}>
          ...
          <Card.Body>
            ...
            <Form onSubmit={handleProfilePhotoSubmit}>
              ...
              <Button variant="primary" className="Button-one" type="submit">
                Upload
              </Button>
            </Form>
          </Card.Body>
        ...
        <Card className={`mx-auto ${styles.personalDetails}`}>
        ...
        <Card className={`mx-auto ${styles.careerInformation}`}>
        ...
        <Card className="mx-auto work-experience-card" style={{ width: "60rem", marginBottom: "25px" }}>
