...
function JobCard() {
  ...
  .sort((a, b) => {
    if (currentUser && currentUser.jobSeekers) {
      const aMatchingScore = calculateMatchingScore(a, currentUser.jobSeekers).score;
      const bMatchingScore = calculateMatchingScore(b, currentUser.jobSeekers).score;
