...
function JobCardAlgo() {
  ...
  .sort((a, b) => {
    if (userData) {
      const aMatchingScore = calculateMatchingScore(a, userData).score;
      const bMatchingScore = calculateMatchingScore(b, userData).score;
    ...
    <div className="d-flex flex-wrap justify-content-between mb-4 w-50">
      <div className="filter-container">
        <div className="filters mb-4 w-100">
         ...
         <div>
           <h5 className="ml-10 bg-color:white">
