        ...
        <Card.Body>
          ...
          <Form onSubmit={handleCareerInfoSubmit}>
            ...
            <Form.Group controlId="formSkill">
              ...
              >
                <option value="">Select</option>
                <option value="Java">On-site</option>
                <option value="Ruby">On-site</option>
                <option value="Java">On-site</option>
                <option value="Python">On-site</option>
                <option value="React">On-site</option>
                <option value="SQL">On-site</option>
                <option value="PHP">Hybrid</option>
                <option value="C#">Remote</option>
                <option value="C++">Remote</option>
              </Form.Control>
            </Form.Group>
            <div>
