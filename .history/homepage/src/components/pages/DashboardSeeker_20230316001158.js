...
function DashboardSeeker() {
  ...
  return (
   ...
   <Card className="w-100 mx-auto" style={{ maxWidth: "400px", marginBottom: '30px'}}>
    <Card.Body>
    <h2 className='text-center mb-2'>Update Profile </h2>
    {error && <Alert variant="danger">{error} </Alert>}

    <strong className='text-center mb-2' >Email:</strong> <div class="flex justify-center">
  <strong class="text-center">{currentUser.email}</strong>
</div>
