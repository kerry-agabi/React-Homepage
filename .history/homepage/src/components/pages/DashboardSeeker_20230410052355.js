...
<Form.Group controlId={`formStartDate${index}`} className="mt-3">
  ...
  <Form.Control
    ...
    onChange={(event) => {
      const newWorkExperiences = [...workExperiences];
      newWorkExperiences[index].startDate = event.target.value;
      setWorkExperiences(newWorkExperiences);
    }}
    required
  />
...
<Form.Group controlId={`formEndDate${index}`} className="mt-3">
  ...
  <Form.Control
    ...
    onChange={(event) => {
      const newWorkExperiences = [...workExperiences];
      newWorkExperiences[index].endDate = event.target.value;
      setWorkExperiences(newWorkExperiences);
    }}
