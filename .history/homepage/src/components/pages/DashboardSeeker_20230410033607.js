        ...
        >
          <Card.Body>
            ...
            <Form onSubmit={handleCareerInfoSubmit}>
              ...
              <Form>
              {skillDropdowns.map((dropdown) => (
  <Form.Group key={dropdown.id} controlId={`formSkill${dropdown.id}`} className="mt-3">
    <Form.Label>Skills</Form.Label>
    <Form.Control as="select" multiple value={dropdown.selectedSkills} onChange={(e) => handleSkillChange(dropdown.id, e)}>
                      <option disabled value="">
                ...
                <Button className="w-100 mt-4" type="submit" onClick={addSkillDropdown}>
