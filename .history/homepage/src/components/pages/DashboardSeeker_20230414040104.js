...
import styles from "./DashboardUpdate.module.css";
...
//start
  return (
    <div className={styles.dashboardUpdateContainer}>
      <Container>
      <Card
        className={`w-100 mx-auto ${styles.cardContainer}`}
        style={{ maxWidth: "400px", marginBottom: "30px" }}
      >
          <Card.Header className={styles.cardHeader}>Update Dashboard</Card.Header>
        ...
        style={{ maxWidth: "400px", marginBottom: "30px" }}
      >
          <Card.Header className={styles.cardHeader}>Profile Photo</Card.Header>
          <Card.Body className={styles.cardBody}>
        ...
        <Card
          className="mx-auto"
          style={{ width: "630rem", marginBottom: "25px" }}
        >
          <Card.Header  className={styles.cardHeader} > Personal Details </Card.Header>
          <Card.Body className={styles.cardBody}>
            {error && <Alert variant="danger">{error}</Alert>}
            {loadingData ? (
      ...
      >
        ...
        style={{ maxWidth: "400px", marginBottom: "30px" }}
      >
         <Card.Header  className={styles.cardHeader}>Work Experience</Card.Header>
          <Card.Body className={styles.cardBody}>
        ...
        style={{ maxWidth: "400px", marginBottom: "30px" }}
      >
         <Card.Header  className={styles.cardHeader}>Education</Card.Header>
          <Card.Body className={styles.cardBody}>
        ...
        style={{ maxWidth: "400px", marginBottom: "30px" }}
      >
         <Card.Header  className={styles.cardHeader}>Upload CV</Card.Header>
          <Card.Body className={styles.cardBody}>
            {fetchedCvUrl && (
              <div>
                <p>Current CV:</p>
