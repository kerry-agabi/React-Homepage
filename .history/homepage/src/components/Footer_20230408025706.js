...
import { faContactCard, faHeadphones, faIcons, faPerson, faPersonBreastfeeding, faPersonHarassing, faSquarePersonConfined } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="footer-links">
        <div className="footer-link-wrapper">
          ...
          <h3>Contact</h3>
            ...
            <Link to="https://www.setu.ie/about">Support  <FontAwesomeIcon icon={faHeadphones} /> </Link>
            <Link to="https://www.linkedin.com/in/gregdoyleitcarlow/">Supervisor <FontAwesomeIcon icon={faSquarePersonConfined} />  </Link>
          </div>
        </div>
        <div className="footer-link-wrapper">
        </div>
