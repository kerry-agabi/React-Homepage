...
import { faContactCard, faHeadphones, faIcons, faPerson, faPersonBreastfeeding, faPersonHarassing, faSquarePersonConfined, faUser } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="footer-links">
        <div className="footer-link-wrapper">
          ...
          <h3>Contact</h3>
            ...
            <Link to="https://www.linkedin.com/in/gregdoyleitcarlow/">Supervisor <FontAwesomeIcon icon={faUser} />  </Link>
          </div>
        </div>
        <div className="footer-link-wrapper">
        </div>
