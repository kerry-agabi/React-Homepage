...
import { faContactCard, faHeadphones, faIcons, faPerson } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="footer-links">
        <div className="footer-link-wrapper">
          ...
          <h3>Contact</h3>
            ...
            <Link to="https://www.linkedin.com/in/gregdoyleitcarlow/">Supervisor <FontAwesomeIcon icon={faIcons} />  </Link>
          </div>
        </div>
        <div className="footer-link-wrapper">
        </div>
