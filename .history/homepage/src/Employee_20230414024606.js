...
const Employee = () => {
  ...
  return (
    ...
    <div className="card">
    <h1 className={styles.heading}>Employee Attrition Prediction</h1>
        ...
        <div className={styles.input-group}>          <label htmlFor="DailyRate">Daily Rate:</label>
          <input type="number" name="DailyRate" onChange={handleChange} value={employeeData.DailyRate} required />
        </div>
        <div className={styles.input-group}>          <label htmlFor="DistanceFromHome">Distance From Home:</label>
          <input type="number" name="DistanceFromHome" onChange={handleChange} value={employeeData.DistanceFromHome} required />
        </div>
        <div className={styles.input-group}>          <label htmlFor="Education">Education:</label>
          <input type="number" name="Education" onChange={handleChange} value={employeeData.Education} required />
        </div>
        <div className={styles.input-group}>          <label htmlFor="EnvironmentSatisfaction">Environment Satisfaction:</label>
        ...
        <div>
          <label htmlFor="OverTime_Yes">Overtime:</label>
