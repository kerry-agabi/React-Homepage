  ...
  return (
    ...
    <div className="card">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label htmlFor="Department_Research_&_Development">Department: Research & Development</label>
          <input type="number" name="Department_Research_&_Development" onChange={handleChange} value={employeeData.Department_Research__Development} required />
        </div>
        <div>
