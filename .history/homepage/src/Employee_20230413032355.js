...
<input type="radio" name="over18" id="yes" value="Yes" onChange={handleChange} />
<label htmlFor="yes">Yes</label>
<input type="radio" name="over18" id="no" value="No" onChange={handleChange} />
...
<select name="performanceRating" id="performanceRating" onChange={handleChange}>
